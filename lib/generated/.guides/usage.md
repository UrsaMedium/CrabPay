...
CrabpayConnectorConnector.instance.DeleteProductProperty(deleteProductPropertyVariables).execute();
...
```dart
await CrabpayConnectorConnector.instance.AddProductProperty({ ... })
.attributes(...)
.execute();
```
