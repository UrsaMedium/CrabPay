...
class ProductCardHorizontalDriver extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        ...
        return _MaterialProductCardHorizontal(
          id: product.id,
...
class _MaterialProductCardHorizontal extends StatelessWidget {
  final String id;
  final String tag;
